...
class NotificationResourceIT {
    ...
    public static Notification createEntity(EntityManager em) {
        Notification notification = new Notification().minutes(DEFAULT_MINUTES).isNotified(DEFAULT_IS_NOTIFIED);
        return notification;
    }
    ...
    public static Notification createUpdatedEntity(EntityManager em) {
        Notification notification = new Notification().minutes(UPDATED_MINUTES).isNotified(UPDATED_IS_NOTIFIED);
        return notification;
    }
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getMinutes()).isEqualTo(DEFAULT_MINUTES);
        assertThat(testNotification.getIsNotified()).isEqualTo(DEFAULT_IS_NOTIFIED);
    }
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].isNotified").value(hasItem(DEFAULT_IS_NOTIFIED.booleanValue())));
    }
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.isNotified").value(DEFAULT_IS_NOTIFIED.booleanValue()));
    }
    ...
    void putNewNotification() throws Exception {
        ...
        updatedNotification.minutes(UPDATED_MINUTES).isNotified(UPDATED_IS_NOTIFIED);
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.getMinutes()).isEqualTo(UPDATED_MINUTES);
        assertThat(testNotification.getIsNotified()).isEqualTo(UPDATED_IS_NOTIFIED);
    }
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.minutes(UPDATED_MINUTES).isNotified(UPDATED_IS_NOTIFIED);
