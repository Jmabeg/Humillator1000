...
describe('Season Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'season', component: SeasonComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to seasonService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSeasonIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSeasonIdentifier).toHaveBeenCalledWith(entity);
