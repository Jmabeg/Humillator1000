...
describe('Club Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'club', component: ClubComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to clubService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getClubIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getClubIdentifier).toHaveBeenCalledWith(entity);
